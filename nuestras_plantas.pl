...
contienente_origen(canela, asia).
...
contienente_origen(cedron, america).
...
contienente_origen(cardo_santo, america).
...
contienente_origen(doradilla, america).
...
contienente_origen(epazote, america).
...
contienente_origen(enebro, europa).
...
contienente_origen(marihuana, asia).
...
contienente_origen(mastuerzo, asia).
...
contienente_origen(matarique, america).
...
contienente_origen(menta, europa).
